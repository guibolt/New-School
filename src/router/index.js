...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "CadastroPessoas"*/ "../views/CadastroPessoas.vue"
      )
  },
  {
    name: "CadastroTurmas",
    ...
    component: () =>
      import(
        /* webpackChunkName: "CadastroTurmas"*/ "../views/CadastroTurmas.vue"
      )
  },
  {
    name: "Turmas",
    ...
    meta: { requiresAuth: true },
    component: () =>
      import(/* webpackChunkName: "Turmas"*/ "../views/Turmas.vue")
  },
  {
    name: "Pessoas",
    path: "/pessoas",
    meta: { requiresAuth: true },
    component: () =>
      import(/* webpackChunkName: "Pessoas"*/ "../views/AlunosEProfessores.vue")
  },
  {
    name: "Sobre",
    path: "/sobre",
